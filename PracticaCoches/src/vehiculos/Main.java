...
import vehiculos.coche.Combustible;
...
public class Main {
	public static void main(String[] args) {
		...
		Sedan sedan = new Sedan("BMW", "Serie 3", "5555EEE", Combustible.GASOLINA, 4);
		Ranchera ranchera = new Ranchera("Skoda", "Octavia", "6666FFF", Combustible.GASOLINA, 600);
